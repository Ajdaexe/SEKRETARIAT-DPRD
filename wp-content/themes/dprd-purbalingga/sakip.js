        ...
        card.innerHTML = `
          ...
          <div class="sakip-card-body-row">
            ...
            <div class="sakip-file-icon">
              <img class="icon-img" src="${themeData.templateUrl}/assets/images/PDF.png" alt="PDF">
            </div>
            <div class="sakip-card-info">
              <h3>${doc.judul}</h3>
              <p>${doc.deskripsi}</p>
              <div class="sakip-card-meta">
                <span class="sakip-meta-item"><img class="icon-img" src="${themeData.templateUrl}/assets/images/admin.png" alt=""> by ${doc.author}</span>
                <span class="sakip-meta-item"><img class="icon-img" src="${themeData.templateUrl}/assets/images/Tear-Off Calendar.png" alt=""> ${doc.tanggal}</span>
              </div>
            </div>
            <button class="sakip-download-btn" onclick="window.location.href='${doc.file}'">
              <img class="icon-img" src="${themeData.templateUrl}/assets/images/unduh.png" alt=""> Unduh
            </button>
          </div>
        `;
