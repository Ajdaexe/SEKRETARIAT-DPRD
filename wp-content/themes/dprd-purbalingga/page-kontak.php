  ...
  <div class="wrap kontak-grid" style="padding:0;">
    ...
    <div class="kontak-left">
      <div class="card-panel">
        ...
        <div class="info-item">
          <div class="ic"><img class="icon-img icon-maps" src="<?php echo get_template_directory_uri(); ?>/images/maps.svg" alt="Alamat"></div>
          <div>
        ...
        <div class="info-item">
          <div class="ic"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/phone.svg" alt="Telepon"></div>
          <div>
            <strong>Telp.</strong>
            <p>(0281) 891058</p>
          </div>
        ...
        <div class="info-item">
          <div class="ic"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/email.svg" alt="Email"></div>
          <div>
            <strong>Email</strong>
        ...
        <div class="info-item">
          <div class="ic"><img class="icon-img icon-website" src="<?php echo get_template_directory_uri(); ?>/images/website.svg" alt="Website"></div>
          <div>
        ...
        <div class="info-item">
          <div class="ic"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/clock tebel.svg" alt="Jam Layanan"></div>
          <div>
      ...
      <div class="card-panel">
        ...
        <div class="lokasi-frame">
          ...
          <div class="lokasi-card">
            <div class="pin"><img class="icon-img icon-maps" src="<?php echo get_template_directory_uri(); ?>/images/maps.svg" alt="Lokasi"></div>
            <div>
...
<section class="cta-section">
  <div class="wrap">
    <div class="cta-banner">
      <div class="cta-left">
        <div class="icon-circle"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/user account.svg" alt=""></div>
