...
<section class="intro-section">
  <div class="wrap intro-grid" style="padding:0;">
    <div class="intro-card intro-card-main">
      <div class="icon-badge"><img src="<?php echo get_template_directory_uri(); ?>/images/university.svg" alt="Sekretariat DPRD"></div>
      ...
      <div class="value-grid">
        <div class="value-item">
          <div class="dot"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/department.svg" alt="Unsur Pelayanan"></div>
        ...
        <div class="value-item">
          <div class="dot"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/verif.svg" alt="Profesional"></div>
          <div class="content-box">
        ...
        <div class="value-item">
          <div class="dot"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/clock tebel.svg" alt="Akuntabel"></div>
          <div class="content-box">
        ...
        <div class="value-item">
          <div class="dot"><img class="icon-img icon-besar" src="<?php echo get_template_directory_uri(); ?>/images/user account.svg" alt="Kolaboratif"></div>
          <div class="content-box">
    ...
    <div class="intro-card sekilas">
      ...
      <div class="sekilas-item">
        <div class="ic"><img src="<?php echo get_template_directory_uri(); ?>/images/flag.svg" alt="Kedudukan"></div>
        <div><strong>Kedudukan</strong><span>Unsur pelayanan administrasi DPRD</span></div>
      </div>
      <div class="sekilas-item">
        <div class="ic"><img src="<?php echo get_template_directory_uri(); ?>/images/department.svg" alt="Tipe Unit Kerja"></div>
        <div><strong>Tipe Unit Kerja</strong><span>Sekretariat DPRD Kabupaten Purbalingga</span></div>
      </div>
      <div class="sekilas-item">
        <div class="ic"><img src="<?php echo get_template_directory_uri(); ?>/images/businessman.svg" alt="Bentuk Organisasi"></div>
        <div><strong>Bentuk Organisasi</strong><span>Perangkat Daerah Kabupaten</span></div>
      </div>
      <div class="sekilas-item">
        <div class="ic"><img src="<?php echo get_template_directory_uri(); ?>/images/document.svg" alt="Jumlah Bagian"></div>
        <div><strong>Jumlah Bagian</strong><span>3 Bagian Utama</span></div>
      </div>
      <div class="sekilas-item">
        <div class="ic"><img src="<?php echo get_template_directory_uri(); ?>/images/flag.svg" alt="Kelompok Jabatan Fungsional"></div>
