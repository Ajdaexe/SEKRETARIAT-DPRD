...
<!-- Hero Section -->
  ...
  <div class="stats" id="statsOverviewGrid">
    <div class="stat-item">
      <div class="stat-icon"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/user account.svg" alt="Pegawai"></div>
      <div>
    ...
    <div class="stat-item">
      <div class="stat-icon"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/university.svg" alt="Agenda"></div>
      <div>
    ...
    <div class="stat-item">
      <div class="stat-icon"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/document.svg" alt="Dokumen"></div>
      <div>
    ...
    <div class="stat-item">
      <div class="stat-icon"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/Protect.png" alt="Transparan"></div>
      <div>
  ...
  <div class="content-grid">
    <div class="card about-card">
      <div class="card-tag"><span class="ic"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/university.svg" alt=""></span> Tentang
        Kami</div>
    ...
    <div class="card video-card">
      <div class="card-tag"><span class="ic"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/Video Call.png" alt=""></span>PERSETUJUAN
      ...
      <div class="info-head">
        <span class="card-tag" style="margin-bottom:0;"><span class="ic"><img class="icon-img" src="<?php echo get_template_directory_uri(); ?>/images/document.svg"
              alt=""></span> Informasi Terbaru</span>
        <a href="<?php echo home_url('/ppid'); ?>#docCard" class="lihat">Lihat Semua &rsaquo;</a>
      </div>
      <div class="info-item" onclick="window.location.href='<?php echo get_template_directory_uri(); ?>/pdf/DOR.pdf'">
  ...
  <div class="ikm-card-new">
    <div class="ikm-top">
      ...
      <div class="ikm-top-right">
        <img src="<?php echo get_template_directory_uri(); ?>/images/badge a.png" alt="Sangat Baik" class="ikm-badge">
      </div>
    </div>
    <div class="ikm-bottom">
      <div class="ikm-bottom-left">
        <img src="<?php echo get_template_directory_uri(); ?>/images/QR Code.png" alt="QR Code" class="ikm-qr">
      </div>
  ...
  <section class="cta-section">
    <div class="cta-banner">
      <div class="cta-left">
        <div class="icon-circle"><img src="<?php echo get_template_directory_uri(); ?>/images/user account.svg" alt=""></div>
