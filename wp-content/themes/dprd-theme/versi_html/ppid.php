<?php
$pageTitle = "PPID - Sekretariat DPRD Kabupaten Purbalingga";
$pageStyle = "ppid-style.css";
$pageScript = "ppid-script.js";
$currentPage = "ppid";
include 'header.php';
?>
...
<!-- Hero Section -->
  ...
  <div class="container">
    ...
    <div class="info-card">
      <div class="info-ic"><img class="icon-img" src="images/informasi.png" alt=""></div>
      <div>
        <h3>Informasi</h3>
    ...
    <div class="type-grid">
      <div class="type-card">
        <div class="type-ic"><img class="icon-img" src="images/informasi berkala.png" alt=""></div>
      ...
      <div class="type-card">
        <div class="type-ic"><img class="icon-img" src="images/informasi serta merta.png" alt=""></div>
      ...
      <div class="type-card">
        <div class="type-ic"><img class="icon-img" src="images/search merah.png" alt=""></div>
      ...
      <div class="type-card">
        <div class="type-ic"><img class="icon-img" src="images/laporan ppid.png" alt=""></div>
        <h5>Laporan PPID</h5>
    ...
    <div class="stats" id="statsOverviewGrid">
      <div class="stat-item">
        <div class="stat-icon"><img class="icon-img" src="images/document.png" alt=""></div>
        <div>
      ...
      <div class="stat-item">
        <div class="stat-icon"><img class="icon-img" src="images/user account.png" alt=""></div>
        <div>
      ...
      <div class="stat-item">
        <div class="stat-icon"><img class="icon-img" src="images/layanan cepat.png" alt=""></div>
        <div>
      ...
      <div class="stat-item">
        <div class="stat-icon"><img class="icon-img" src="images/Protect.png" alt=""></div>
        <div>
    ...
    <div class="doc-card" id="docCard">
      ...
      <div class="search-box">
        ...
        <span class="sic"><img class="icon-img" src="images/search merah.png" alt=""></span>
      </div>
    ...
    <section class="cta-section">
      <div class="cta-banner">
        <div class="cta-left">
          <div class="cta-ic"><img class="icon-img" src="images/Headphones.png" alt=""></div>
          <div>
